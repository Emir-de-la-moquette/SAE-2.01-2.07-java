...
public class Epreuve implements Participation<Equipe>, Data {
    ...
    public boolean estRealise = false;
    ...
    */  
    ...
    public void reinitialiser(){
        this.estRealise = false;
        this.pallierMatch = new HashMap<Integer, List<MatchDuel>>();
        this.lesMatchs = new ArrayList<Match>();
    ...
    public void lanceEpreuve2(boolean reel){

        if(this.estRealise) {System.out.println("Cette épreuve à déjà été réalisée."); return;}
